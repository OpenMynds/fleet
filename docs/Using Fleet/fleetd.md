...
| --orbit-extensions-update-check-interval   | Specifies the interval duration for performing Orbit extension update checks                                                            |
| --orbit-flags-check-interval               | Defines the time interval at which Orbit flags are checked for updates                                                                  |
| --orbit-server-capabilities-check-interval | Determines the frequency at which Orbit verifies the server capabilities for changes                                                    |
